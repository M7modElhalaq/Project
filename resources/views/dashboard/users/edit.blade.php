                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header" id="top">
                                ...
                                <p class="pageheader-text">Edit member.</p>
                                ...
                                <div class="card-body">
                                    <form action="{{route('update_user', ['id' => $user->id])}}" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputEmail" type="email" placeholder="Your Email" value="{{$user->email}}" name="email" class="form-control">
                                            <p>We'll never share your email with anyone else.</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputPassword">Password</label>
                                            <input id="inputPassword" type="password" placeholder="Password" value="{{decrypt($user->password)}}" name="password" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="input-select" name="role">
                                                ...
                                                <option value="2" @if($user->role === 2) @endif>Subscriber</option>
                                                <option value="3" @if($user->role === 3) @endif>User</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
