            ...
            <div class="card-body">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        <input class="form-control form-control-lg{{ $errors->has('email') ? ' is-invalid' : '' }}" id="username" type="text" placeholder="Username" autocomplete="off"  name="email" value="{{ old('email') }}" required autofocus>
                        @if ($errors->has('email'))
                    ...
                    <div class="form-group">
                        <input class="form-control form-control-lg{{ $errors->has('password') ? ' is-invalid' : '' }}" id="password" type="password" placeholder="Password" name="password" required>
